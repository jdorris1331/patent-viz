...
query = "SELECT patent_data.ID, patent_info.title, patent_data.claims, patent_data.abstract FROM patent_info INNER JOIN patent_data ON patent_info.ID=patent_data.ID" 
